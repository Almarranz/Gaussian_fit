...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 26 11:39:14 2021
...
#%%
# ñ=26    
# print(np.sum(pij[:,ñ]),h1[0][ñ])
# fig,ax=plt.subplots(1,1)
# ax.hist(v_y,bins=auto,edgecolor='black',linewidth=2,density=False,alpha=0.5)
# vy_p=[np.sum(pij[:,i]) for i in range(len(h1[1])-1)]
# vy_p=list(vy_p)
# ax.scatter(x,vy_p,alpha=0.3,color='red')
...
# l=h[1][15]
# u=h[1][16]
# lim=np.linspace(l,u,len(x))
# ax.plot(lim,snd.pdf(x))
# print(h[1][0],h[1][1],len(h[1]))
# 
# 
# snd = stats.norm(mu, std)
# #
